    ...
    return(
        <main className="shortly">
            ...
            <section className="shortly__tldr">
                <h2>tl;dr</h2>
                <p>Shortly is a simple URL - Shortening website which is based from <Link to="https://www.frontendmentor.io/challenges/url-shortening-api-landing-page-2ce3ob-G">this challenge</Link> from frontendmentor. The original challenge was just a simple landing page which is why I made some changes in order to make it a little bit bigger. I also replaced the original API with a different one as the first one stopped working so I had to find a replacement.</p>
                <p>Before minify, this was my biggest project which I know, isn&apos;t really that much. One of the differences tho is that I didn&apos;t use Figma when I was doing the layout for the other pages.</p>
            </section>

            <section className="shortly__overview">
                <h2>Overview</h2>
                <p>Before minify, this was my most significant project. I know, isn&apos;t really that much but it served as a good reminder for me that I was doing a great job in terms of improvements. One thing, tho, is that I did not use Figma to make the designs for the other pages which is why I unfortunately  won&apos;t be adding any snippets here.</p>
                
                <section className="shortly__overview--feature">
                    <h3>URL - Shortening</h3>
                    <p>The functionality itself is pretty self explanatory. Tho, you can only shorten a link one at a time. The previous response will also change if you were to shorten another link.</p>
                </section>
            </section>
            ...
            <section className="shortly__technical">
                ...
                <section className="shortly__technical--designing">
                    <h3>Designing</h3>
                    <p>As I&apos;ve mentioned. this project was adopted from the URL - Shortener challenge from frontendmentor. The problem, though, was that the original challenge only has landing page and since I wanted to add this to my portfolio, I decided to make some additions and changes that I think suits the project well.</p>
                ...
                <section className="shorly__technical--development">
                    <h3>Development</h3>
                    <p>Just like minify, I also used React as well as SASS for the front-end. For this project, I originally tried to add a backend using express but I eventually removed it because I didn&apos;t know about hosting backend on render at that time.</p>
                    <div className="development__mid">
                        <p>Looking at the layout of the project, I already knew that the <code>Form</code> where the user can put the links that they can shorten will have <code>position: relative</code> to it and the response will be in <code>position: absolute</code> which is why I didn&apos;t worry much about the layout.</p>
            ...
            <section className="shortly__difficulties">
                <h2>Difficulties</h2>
                <p>The first major hurdle was the illustration on the hero section of the landing page. I originally thought that it was different from the original design but I realized that I was limiting the width of the entire container to add spacing on both right and left so it was bound to look like that.</p>
                <p>Other than that, finding a good replacement for the original API was also quite a problem. What happened was the site of the first API that I was using went down for some reason and didn&apos;t came back so I had to find a good replacement for it. There were some candidates but most of them were lackluster which is why I eventually settled with bit.ly.</p>
            ...
            <section className="shortly__overall">
                <h2>Overall</h2>
                <p>Honestly, this project was quite easy. Aside from some minor layout conflicts and the api changes, it was pretty much smooth sailing.</p>
